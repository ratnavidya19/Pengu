...
public class PenguAction {
	...
	public static PenguModelAStarSearch penguModelAStarSearch;
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 penguModelAStarSearch = new PenguModelAStarSearch();
			...
			if(working_FrozenField != null)
			{
				...
				((PenguModelAStarSearch) penguModelAStarSearch).initialiseVariables();
